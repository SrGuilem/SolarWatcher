...
String pyt_server_name = "http://127.0.0.1:5000/modulos";
...
void SendToPython(String current, String voltage, String dateTime){
  ...
  http.begin(client, py_server_name)
  http.addHeader("Content-Type", "application/json");

  int httpResponseCode = http.POST("{\"Corrente\":"current",\"Tensão\":"voltage",\"Data/Hora\": "dateTime"}");
